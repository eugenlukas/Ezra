//TextEditor from https://github.com/BalazsJako/ImGuiColorTextEdit with MIT license and modifications for this project
	...
	, mStartTime(std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::system_clock::now().time_since_epoch()).count())
{
	...
	SetLanguageDefinition(LanguageDefinition::ASM_4BIT());
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::ASM_4BIT()
{
	...
	if (!inited)
	{
		static const char* const keywords[] = {
			"var", "and", "or", "not", "if", "then", "elif", "else", "for", "to", "step", "while", "func", "return", "continue", "break", "module", "as", "link", "extern"
		};
		...
		static const char* const identifiers[] = {
			"NULL", "TRUE", "FALSE", "MATH_PI", "PRINT", "PRINTLN", "LENGTH", "INPUT_STR", "INPUT_NUM", "IS_NUM", "IS_STR", "IS_LIST", "IS_FUNC", "APPEND", "POP", "EXTEND",
			"CLEAR", "SYSTEM", "RANDOM", "RANDOMIZE"
		};
